          ...
          if (obj["data"]["top"]) {
            let top = obj["data"]["top"].filter((e) => {
              if (e.id === 222 || e.id === 107) {
                ...
                e.icon = "https://raw.githubusercontent.com/Ishiharaerika/China-Censorship-Withdrawal/main/QuantumultX/Rewrite/bilibili_icon.png";
                e.tab_id = "Story_Top";
                e.name = "Story";
              }
